...
const ToDo = () => {
    ...
    let loginEvent = "show"
    let todoEvent = "dont-show"

    function changeModal(e) {
        if(e.type == "click"){
            loginEvent = "dont-show"
            todoEvent = "show"
        }
    }
    ...
    return (
        <>
            <button type="button" className="btn btn-primary" onChange={changeModal}>Primary</button>
            <div className={loginEvent}>
                ...
                <form className="d-flex justify-content-center flex-column" onSubmit={(e) => {
                    ...
                    <button onClick={() => getData()} type="submit" className="btn btn-primary">Create</button>
                </form>
            </div>
